<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-lg"><b> Online Voting </b>System</span>
    </a>
    <!-- Header Navbar: style can be found in header.css -->
    <nav class="navbar navbar-static-top" style=" border-buttom: 2px solid black ;">
